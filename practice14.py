...
def vender_entrada(cliente, partido, tipo):
    ...
    # print_stadiums_from_api()  # Utiliza la función para imprimir el estadio
...
# def vender_entrada(cliente, partido, tipo):
#     asiento = buscar_asiento_libre(partido)  # Busca un asiento libre para el partido
#     if asiento is None:
#         print("No hay asientos disponibles para este partido.")
#         return None  # Retorna None si no se encuentra un asiento libre
#     costo = calcular_costo_entrada(partido, tipo, cliente.cedula)
#     entrada = crear_entrada(cliente, partido, tipo, asiento, costo)
#     asiento.ocupado = True  # Marca el asiento como ocupado
#     actualizar_asiento(asiento)
#     return entrada

# # Función para buscar un asiento libre
# def buscar_asiento_libre(partido):
#     for fila in range(len(asientos)):
#         for asiento in range(len(asientos[fila])):
#             if asientos[fila][asiento].ocupado == False:  # Verifica si el asiento está libre
#                 return asientos[fila][asiento]  # Retorna el asiento libre
#     return None
